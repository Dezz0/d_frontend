...
export default function AdminUsersScreen() {
  ...
  const userStats = users ? [
    ...
    { value: users.filter(u => u.is_admin).length.toString(), label: 'Администраторов' },
    { value: users.filter(u => !u.is_admin).length.toString(), label: 'Пользователей' }
  ] : [];
                ...
                {!user.is_admin &&
                  <View style={styles.userStats}>
                    <View style={styles.statItem}>
                      <Text style={styles.statValue}>{user.applications_count}</Text>
                      <Text style={styles.statLabel}>Всего заявок</Text>
                    </View>
                    <View style={styles.statItem}>
                      <Text style={[styles.statValue, styles.pendingValue]}>{user.pending_applications}</Text>
                      <Text style={styles.statLabel}>В ожидании</Text>
                    </View>
                    <View style={styles.statItem}>
                      <Text style={[styles.statValue, styles.approvedValue]}>{user.approved_applications}</Text>
                      <Text style={styles.statLabel}>Одобрено</Text>
                    </View>
                    <View style={styles.statItem}>
                      <Text style={[styles.statValue, styles.rejectedValue]}>{user.rejected_applications}</Text>
