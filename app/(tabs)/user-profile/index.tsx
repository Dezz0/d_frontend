          ...
          <View style={styles.statsSection}>
            ...
            <View style={styles.statsGrid}>
              <View style={styles.statCard}>
                <Text style={styles.statNumber}>{profile.total_applications}</Text>
                <Text style={styles.statLabel}>Всего заявок</Text>
              </View>

              <View style={styles.statCard}>
                <Text style={[styles.statNumber, styles.pendingStat]}>{profile.pending_applications}</Text>
                <Text style={styles.statLabel}>В ожидании</Text>
              </View>

              <View style={styles.statCard}>
                <Text style={[styles.statNumber, styles.approvedStat]}>{profile.approved_applications}</Text>
                <Text style={styles.statLabel}>Одобрено</Text>
              </View>

              <View style={styles.statCard}>
                <Text style={[styles.statNumber, styles.rejectedStat]}>{profile.rejected_applications}</Text>
            ...
            {profile?.total_rooms !== undefined && profile.total_rooms > 0 && (
              <View style={styles.hardwareStats}>
                <View style={styles.hardwareCard}>
                  <Text style={styles.hardwareNumber}>{profile.total_rooms}</Text>
                  <Text style={styles.hardwareLabel}>Комнат</Text>
                </View>
                <View style={styles.hardwareCard}>
                  <Text style={styles.hardwareNumber}>{profile.total_sensors}</Text>
